...
<body>
  ...
  <section class="fv">
    <div class="fv__contents">
      ...
      <button class="btn btn_size_l fv__btn"><a href="<?php bloginfo('url'); ?>/contact" class="btn__link">資料請求</a></button>
      <div> <a href="<?php bloginfo('url'); ?>/contact" class="fv__contact">お問い合わせ</a></div>
    </div>
  ...
  <main>
    ...
    <section class="price">
      <div class="section__inner price__content">
        ...
        <button class="price__btn"><a class="price__link" href="<?php bloginfo('url'); ?>/price">料金を見てみる</a></button>
      </div>
    </section>
    <!-- //price -->
        ...
        <div class="card__content">
          ...
          <div class="card__item">
            ...
            <div class="card__info-box">
              <div class="card__img">
                ...
                <?php
                $imagefiled = get_field('card_img_1');
                if (!empty($imagefiled)) {
                ?>
          ...
          <div class="card__item">
            ...
            <div class="card__info-box">
              <div class="card__img">
                <?php
                $imagefiled = get_field('card_img_2');
                if (!empty($imagefiled)) {
                ?>
                  <img src="<?php echo $imagefiled['url']; ?>" alt="<?php echo $imagefiled['alt']; ?>" />
                <?php } ?>
          ...
          <div class="card__item">
            ...
            <div class="card__info-box">
              <div class="card__img">
                <?php
                $imagefiled = get_field('card_img_3');
                if (!empty($imagefiled)) {
                ?>
                  <img src="<?php echo $imagefiled['url']; ?>" alt="<?php echo $imagefiled['alt']; ?>" />
                <?php } ?>
            ...
            ?>
                <li class="blog-info__item">
                  <a href="<?php the_permalink(); ?>" class="blog-info__link">
                    ...
                    <?php else : ?>
                      <img class="blog-info__img" src="<?php echo get_template_directory_uri(); ?>/img/no-img.jpeg" alt="">
                    <?php endif; ?>
            ...
            ?>
                ...
                <li class="blog-info__info-item">
                  <a href="<?php the_permalink(); ?>">
                    ...
                    <p class="blog-info__info-date"><?php the_time(get_option('date_format')); ?></p>
  ...
  <div class="phone-text">
    <p class="phone-text__text">お電話でのお問い合わせはこちら<span class="phone-text__phone-num"><a class="phone-text__text_link">0123-456-7890</a></span><span class="phone-text__time">平日 08:00~20:00</span></p>
  </div>
  <!-- //phone-text -->
